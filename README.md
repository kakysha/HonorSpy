...
**Limit number of table rows to reduce lag on standings open.** Default limit is set to: 1000. Go to *Esc → Interface Options → Addons → HonorSpy* to set the limit and other options.
